  ...
  return (
    <Link to={`/collection/${item.collection}`}>
      <div className="flex flex-col w-[147.5px] h-[209px] md:w-[150px] msc:w-[165px] msc:h-[209px] fs:w-[243px] xl:w-80 fs:h-[316px] rounded-[20px] bg-[#3B3B3B]">
        ...
        <div className="w-[149.5px] h-[148px] md:w-[158px] msc:w-[170px] msc:h-[148px] fs:w-[248px] fs:h-[250px] xl:w-80 rounded-tl-[20px] rounded-tr-[20px]">
          <img
            ...
            className="w-[149.5px] h-[148px] md:w-[158px] msc:w-[170px] msc:h-[148px] fs:w-[248px] fs:h-[250px] xl:w-80 rounded-tl-[20px] rounded-tr-[20px]"
            src={item.image_url}
